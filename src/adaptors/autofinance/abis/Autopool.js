module.exports = {
  autopoolAbi: [
    ...
    {
      inputs: [
        { internalType: 'address', name: 'destinationVault', type: 'address' },
      ],
    ...
    {
      inputs: [
        { internalType: 'address', name: '_pastRewarder', type: 'address' },
      ],
      name: 'isPastRewarder',
      outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
      stateMutability: 'view',
    ...
    },
    {
      ...
      name: 'rewarder',
      outputs: [
        { internalType: 'contract IMainRewarder', name: '', type: 'address' },
      ],
      stateMutability: 'view',
      type: 'function',
    },
    {
      inputs: [
        { internalType: 'address', name: 'newFeeSink', type: 'address' },
      ],
      name: 'setFeeSink',
      outputs: [],
      stateMutability: 'nonpayable',
    ...
    {
      inputs: [
        { internalType: 'uint256', name: 'numToProcess', type: 'uint256' },
      ],
