...
const CHAINS = [
  {
    id: 1,
    name: 'ethereum',
    url: `https://gateway-arbitrum.network.thegraph.com/api/${process.env.TRADERJOE}/subgraphs/id/37rapC8GX3YmFpv1y8BWmu5xvHPLTRvn3uxQHd6CEmJ7`,
    address: '0xc67cb09d08521cD1dE6BAAC46824261eb1dB8800',
  },
  {
    id: 42161,
    name: 'arbitrum',
    url: `https://gateway-arbitrum.network.thegraph.com/api/${process.env.TRADERJOE}/subgraphs/id/CCYS6JgDCPHdMphsnHSrosEkbmmBhb69gwKLqRaxuCwK`,
    address: '0xf878a060D4d51704B14e8f68B51185bF5DbFE3A1',
  },
  {
    id: 10,
    name: 'optimism',
    url: `https://gateway-arbitrum.network.thegraph.com/api/${process.env.TRADERJOE}/subgraphs/id/Fu6e7h47iJ2V4FdsPbogouXVSdDhmBET4gtKPNSZU7tM`,
