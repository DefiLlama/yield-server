...
const apiUrl_wbethVault_bsc = 'https://data.cian.app/bsc/api/v1/bsc_vault_wbeth/apy';
...
async function fetch() {
  ...
  const response_wbethVault_bsc = (await axios.get(apiUrl_wbethVault_bsc)).data.data;
