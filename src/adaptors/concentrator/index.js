...
const aladdinFXN = '0x00Bac667a4cCf9089aB1Db978238C555C4349545';
...
const getATokenData = async () => {
  ...
  const { aCRV, asdCRV, aladdinCVX, arUSD, aFXN } = aTokenData.data;
  const newObj = [
    {
    ...
    {
      pool: `${aladdinFXN}-concentrator`,
      chain: utils.formatChain('ethereum'),
      project: 'concentrator',
      symbol: 'aFXN',
      tvlUsd: parseInt(aFXN.tvl, 10),
      apy: parseFloat(aFXN.apy),
    },
  ];
  return newObj;
};
