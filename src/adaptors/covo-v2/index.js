...
const polygonusdcstakingtracker =
  '0xED29cB1b164dd7EA1c5065E79a15dA31EC34327B';

  const polygoncovostakingtracker =
  '0x569629f42c79752436dba855ba7eb577a56e478c';
...
async function getPoolCovo(
 ...
 const RewardsdistributorCovo2 =  parseFloat(RewardsdistributorCovo1.dividedBy(decimal3));
 ...
 const PolygonStakedCovo2 =  parseFloat(PolygonStakedCovo1.dividedBy(decimal3));
    ...
    const totalRewardsInUSDC = (stakedCovoclaimedUSDC1+(stakedCovoPendingUSDC2))/(100000)
    ...
    const yearlyInflationcovo = (RewardsdistributorCovo2 * secondsPerYear * pPriceData.gmx.usd);
...
async function getPoolUsdc(
  ...
  let PolygonUSDCPoolBalance2 = parseFloat (PolygonUSDCPoolBalance);
     ...
     const totalRewardsInUSDC = (stakedCovoclaimedUSDC1+(stakedCovoPendingUSDC2))/(1000000)
