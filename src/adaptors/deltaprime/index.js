...
const WAVAX_TOKEN_ADDRESS = ADDRESSES.avax.WAVAX;
const USDC_TOKEN_ADDRESS = ADDRESSES.avax.USDC;
const USDT_TOKEN_ADDRESS = ADDRESSES.avax.USDt;
const BTC_TOKEN_ADDRESS = ADDRESSES.avax.BTC_b;
const ETH_TOKEN_ADDRESS = ADDRESSES.avax.WETH_e;
...
const USDC_TOKEN_ARBI_ADDRESS = ADDRESSES.arbitrum.USDC_CIRCLE;
const ETH_TOKEN_ARBI_ADDRESS = ADDRESSES.arbitrum.WETH;
const ARB_TOKEN_ARBI_ADDRESS = ADDRESSES.arbitrum.ARB;
const BTC_TOKEN_ARBI_ADDRESS = ADDRESSES.arbitrum.WBTC;
const DAI_TOKEN_ARBI_ADDRESS = ADDRESSES.optimism.DAI;
