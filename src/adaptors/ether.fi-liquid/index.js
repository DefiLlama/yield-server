  ...
  const pools = [
    {
      ...
      pricePerShare: liquidETHRateCurrent / 1e18,
    ...
    },
    {
      ...
      pricePerShare: liquidUSDRateCurrent / 1e6,
    ...
    },
    {
      ...
      pricePerShare: liquidBTCRateCurrent / 1e8,
    ...
    },
    {
      ...
      pricePerShare: liquidHYPEOracleData?.currentRate ?? null,
