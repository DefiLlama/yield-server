...
const rpcUrlBase = 'https://opt-mainnet.g.alchemy.com/v2/'
const apiKey = {
  optimism: 'oEk9gsFsYITNlTL4guXm5BmhcRZ24NfA',
  base: '4uTkolRkEpkMx7Egth0pzjJAd9IbYsJc'
}

exports.getVeloPoolInfo = async function (poolAddress, chain) {
  const rpcUrl = `${rpcUrlBase}${apiKey[chain]}`
