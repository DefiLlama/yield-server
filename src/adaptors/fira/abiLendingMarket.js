module.exports = [
    ...
    inputs: [
      {
        indexed: true,
        internalType: 'address',
        name: 'newUslLiquidator',
        type: 'address',
      },
    ],
    name: 'SetUslLiquidator',
    type: 'event',
  },
  {
    anonymous: false,
  ...
  },
  {
    inputs: [
      ...
      },
      {
        ...
        internalType: 'struct MarketConstants',
        name: 'constants',
        type: 'tuple',
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'supplyAssets', type: 'uint256' },
  ...
  },
  {
    ...
    name: 'liquidateExpiredUSL',
    outputs: [
      { internalType: 'uint256', name: 'seizedAssets', type: 'uint256' },
      { internalType: 'uint256', name: 'repaidAssets', type: 'uint256' },
    ],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  {
    inputs: [{ internalType: 'Id', name: '', type: 'bytes32' }],
    name: 'marketConstants',
    outputs: [
      { internalType: 'uint128', name: 'maturityGracePeriod', type: 'uint128' },
      {
        internalType: 'uint128',
        name: 'liquidationIncentive',
        type: 'uint128',
  ...
  {
    inputs: [
      { internalType: 'address', name: 'newUslLiquidator', type: 'address' },
    ],
    name: 'setUslLiquidator',
    outputs: [],
    stateMutability: 'nonpayable',
