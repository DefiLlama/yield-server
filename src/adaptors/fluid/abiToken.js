module.exports = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: 'receiver_', type: 'address' },
      { internalType: 'uint256', name: 'maxAssets_', type: 'uint256' },
    ],
    name: 'mint',
  ...
  {
    inputs: [
      { internalType: 'address', name: 'newRebalancer_', type: 'address' },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: 'receiver_', type: 'address' },
      { internalType: 'address', name: 'owner_', type: 'address' },
      { internalType: 'uint256', name: 'maxSharesBurn_', type: 'uint256' },
    ],
    name: 'withdraw',
    outputs: [{ internalType: 'uint256', name: 'shares_', type: 'uint256' }],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'sharesToPermit_', type: 'uint256' },
      { internalType: 'uint256', name: 'assets_', type: 'uint256' },
      { internalType: 'address', name: 'receiver_', type: 'address' },
      { internalType: 'address', name: 'owner_', type: 'address' },
      { internalType: 'uint256', name: 'maxSharesBurn_', type: 'uint256' },
