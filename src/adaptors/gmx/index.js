...
async function getPoolGmx(pChain, pInflationTrackerAddress, pStakedGmx, pStakedEsGmx, pFeeGmx, pInflationGmx, pPriceData) {
    const tvlGmx = pPriceData.gmx.usd * await getAdjustedAmount(pChain == 'arbitrum' ? arbitrumGmxAddress : avalacheGmxAddress, pChain, 'erc20:balanceOf', pChain == 'arbitrum' ? [arbitrumInflationGmxTrackerAddress] : [avalancheInflationGmxTrackerAddress])
...
const getPools = async () => {
    ...
    pools.push(await getPoolGmx('avax', avalancheInflationGmxTrackerAddress, avalancheStakedGmx, avalancheStakedEsGmx, avalancheFeeGmx, avalancheInflationGmx, priceData))
    ...
    pools.push(await getPoolGlp('avax', await getGlpTvl('avax'), avalancheInflationGlpTrackerAddress, avalancheFeeGlp, avalancheInflationGlp, priceData))
