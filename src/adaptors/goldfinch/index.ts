...
const API_URL = 'https://api.thegraph.com/subgraphs/name/goldfinch-eng/goldfinch-v2';
...
async function apy() {
    ...
    const {estimatedApy, estimatedApyFromGfiRaw, totalPoolAssetsUsdc} = seniorPoolStatus
