module.exports = [
  ...
  {
    inputs: [
      { internalType: 'contract INFTPool', name: 'nftPool', type: 'address' },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'poolEmissionRate', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [{ internalType: 'address', name: 'nftPool', type: 'address' }],
    name: 'updatePool',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
