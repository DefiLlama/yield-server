module.exports = [
  ...
  {
    inputs: [
      { internalType: 'bool[]', name: '_skipFlags', type: 'bool[]' },
      { internalType: 'bool[]', name: '_skipReward', type: 'bool[]' },
    ...
    name: 'harvest',
    outputs: [
      { internalType: 'uint256[][]', name: '_res', type: 'uint256[][]' },
    ],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: '_guardedToken', type: 'address' },
      { internalType: 'address', name: '_governanceFund', type: 'address' },
  ...
  },
  {
    inputs: [
      { internalType: 'uint256', name: '_amount', type: 'uint256' },
      { internalType: 'bool', name: '_revertIfNeeded', type: 'bool' },
    ],
    name: 'liquidate',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_idealRange', type: 'uint256' }],
    name: 'setIdealRange',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'bool', name: '_isStkAAVEActive', type: 'bool' }],
  ...
  {
    inputs: [
      { internalType: 'address', name: '_AAStaking', type: 'address' },
      { internalType: 'address', name: '_BBStaking', type: 'address' },
    ],
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_unlentPerc', type: 'uint256' }],
    name: 'setUnlentPerc',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    ...
    name: 'virtualPrice',
    outputs: [
      { internalType: 'uint256', name: '_virtualPrice', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
