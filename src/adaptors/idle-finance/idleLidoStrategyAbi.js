module.exports = [
  ...
  {
    inputs: [
      { internalType: 'address', name: '_strategyToken', type: 'address' },
  ...
  },
  {
    inputs: [],
    name: 'pullStkAAVE',
    outputs: [{ internalType: 'uint256', name: '_bal', type: 'uint256' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{ internalType: 'address', name: '_cdo', type: 'address' }],
