...
module.exports = [
  ...
  },
  {
    ...
    inputs: [],
    name: 'gst2',
    outputs: [{ internalType: 'contract GasToken', name: '', type: 'address' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    inputs: [
      { internalType: 'uint256', name: '_amount', type: 'uint256' },
      { internalType: 'bool[]', name: '_skipGovTokenRedeem', type: 'bool[]' },
    ],
    name: 'redeemIdleTokenSkipGov',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    constant: false,
    inputs: [{ internalType: 'address', name: '_aToken', type: 'address' }],
    name: 'setAToken',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  },
  {
    constant: false,
    inputs: [
      { internalType: 'address[]', name: 'protocolTokens', type: 'address[]' },
      { internalType: 'address[]', name: 'wrappers', type: 'address[]' },
      { internalType: 'address[]', name: '_newGovTokens', type: 'address[]' },
      {
        internalType: 'address[]',
        name: '_newGovTokensEqualLen',
        type: 'address[]',
      },
    ],
    name: 'setAllAvailableTokensAndWrappers',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    constant: false,
    inputs: [{ internalType: 'address', name: '_cToken', type: 'address' }],
    name: 'setCToken',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  {
    constant: false,
    inputs: [{ internalType: 'uint256', name: '_perc', type: 'uint256' }],
    name: 'setMaxUnlentPerc',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    constant: false,
    inputs: [
      { internalType: 'address', name: '_tokenHelper', type: 'address' },
    ],
    name: 'setTokenHelper',
    outputs: [],
    payable: false,
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256', name: 'priceWFee', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  },
