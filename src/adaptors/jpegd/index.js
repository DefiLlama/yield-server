...
var getApecoinApy = require('./apy').getApecoinApy;
var poolsFunction = function () { return __awaiter(_this, void 0, void 0, function () {
    var _a, apeApy, tvlData, APE, apePool;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), apeApy = _a[0], tvlData = _a[1];
