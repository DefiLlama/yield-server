...
const COINS = [
  ...
  ["amAPT", "coingecko:amnis-aptos", 8, '0x111ae3e5bc816a5e63c2da97d0aa3886519e0cd5e4b046659fa35796bd11542a::amapt_token::AmnisApt'],
  ...
  ["wUSDC", "coingecko:usd-coin", 6, "0x5e156f1207d0ebfa19a9eeff00d62a282278fb8719f4fab3a586a0a2c0fffbea::coin::T"],
  ["WBTC", "coingecko:bitcoin", 6, "0xf22bede237a07e121b56d91a491eb7bcdfd1f5907926a9e58338f964a01b17fa::asset::WBTC"],
  ["zWETH", "coingecko:ethereum", 6, "0xf22bede237a07e121b56d91a491eb7bcdfd1f5907926a9e58338f964a01b17fa::asset::WETH"],
  ["CELL", "coingecko:cellana-finance", 8, "0x2ebb2ccac5e027a87fa0e2e5f656a3a4238d6a48d93ec9b610d570fc0aa0df12"],
];
...
async function main() {  
    ...
    return await Promise.all(COINS.map(async (coin) => {
      ...
      if (!coinPrice) {
        const aptosPriceRes = await utils.getData(`${COINS_LLAMA_PRICE_URL}aptos:${coinAddr}`);
