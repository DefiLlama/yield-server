...
const subgraphMorphoAave = `https://gateway-arbitrum.network.thegraph.com/api/${process.env.GRAPH_PROTOCOL}/subgraphs/id/FKVL7B5yEHvz1GKB9hFpwp64YLN5KXS27aWpQLngyECx`;
