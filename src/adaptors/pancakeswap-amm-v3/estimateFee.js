...
function parseProtocolFees(feeProtocol) {
    var packed = Number(feeProtocol);
    if (Number.isNaN(packed)) {
        throw new Error("Invalid fee protocol " + feeProtocol);
    }
    var token0ProtocolFee = packed % Math.pow(2, 16);
    var token1ProtocolFee = packed >> 16;
    return [token0ProtocolFee / FEE_BASE, token1ProtocolFee / FEE_BASE];
}
module.exports.EstimatedFees = function (poolAddress, priceAssumptionValue, priceRangeValue, currentPriceUSDToken1, currentPriceUSDToken0, depositAmountUSD, decimalsToken0, decimalsToken1, feeTier, url, volume, feeProtocol) { return __awaiter(_this, void 0, void 0, function () {
    var P, Pl, Pu, priceUSDX, priceUSDY, protocolFee, _a, amount0, amount1, deltaL, currentTick, poolTicks, L, estimatedFee, estimatedFeeAfterProtocolFee;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                protocolFee = parseProtocolFees(feeProtocol)[0];
            ...
            case 1:
                ...
                estimatedFeeAfterProtocolFee = estimatedFee * (1 - protocolFee);
                return [2 /*return*/, { poolAddress: poolAddress, estimatedFee: estimatedFeeAfterProtocolFee }];
        }
    });
}); };
