module.exports = [
  {
    inputs: [
      ...
      { internalType: 'address', name: '_firstOwner', type: 'address' },
    ],
  ...
  {
    inputs: [{ internalType: 'address', name: '_funder', type: 'address' }],
    name: 'addFunder',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'minExtension', type: 'uint256' },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bool[]', name: 'overwrites', type: 'bool[]' },
    ],
    name: 'setPools',
    outputs: [],
    stateMutability: 'nonpayable',
