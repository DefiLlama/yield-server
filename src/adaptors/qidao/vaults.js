  ...
  [ChainId.MATIC]: [
    {
      ...
      subgraph:
        'https://gateway-arbitrum.network.thegraph.com/api/${process.env.TRADERJOE}/subgraphs/id/7xxKjtYc6yfDaSo2TDquGtZbxSXqdDnyfCZgvWGtXrRd',
    ...
    },
    {
      chainId: ChainId.MATIC,
      subgraph:
        'https://gateway-arbitrum.network.thegraph.com/api/${process.env.TRADERJOE}/subgraphs/id/Ap8NjXbJ261qLEDJY79WDMBoB8noFCssqXVPeo2eHwuz',
    ...
    },
    {
      chainId: ChainId.MATIC,
      subgraph:
        'https://gateway-arbitrum.network.thegraph.com/api/${process.env.TRADERJOE}/subgraphs/id/7DP4Egj28CbrrqVZALKqJehqYJa7AsvHwNUZXHVZ8hAd',
    ...
    },
    {
      chainId: ChainId.MATIC,
      subgraph:
        'https://gateway-arbitrum.network.thegraph.com/api/${process.env.TRADERJOE}/subgraphs/id/4nCf52ozAhJvfzk9Fv7FvFTg4VtKTKVEW6X6kg1FKMYM',
    ...
    },
    {
      chainId: ChainId.MATIC,
      subgraph:
        'https://gateway-arbitrum.network.thegraph.com/api/${process.env.TRADERJOE}/subgraphs/id/C9M2n9nEygAcbRzhns1hTVBDTbwtaPUci6DrWTnkj2fA',
    ...
    },
    {
      chainId: ChainId.MATIC,
      subgraph:
        `https://gateway-arbitrum.network.thegraph.com/api/${process.env.TRADERJOE}/subgraphs/id/4TAKynX2eqkih6Cob4pBBCxtkgUtBR6QgvsSwA8y9joQ`,
    ...
    },
    {
      chainId: ChainId.MATIC,
      subgraph:
        `https://gateway-arbitrum.network.thegraph.com/api/${process.env.TRADERJOE}/subgraphs/id/2n8LDgHqDMamjXvchFyTgU7o3YndcWVBLcTUFUx7C8Xp`,
    ...
    },
    {
      chainId: ChainId.MATIC,
      subgraph:
        `https://gateway-arbitrum.network.thegraph.com/api/${process.env.TRADERJOE}/subgraphs/id/8Yihy9U8n4KnMPn2G4iiWfUycDhKZMhyCQn5urMWsWVi`,
    ...
    },
    {
      chainId: ChainId.MATIC,
      subgraph:
        `https://gateway-arbitrum.network.thegraph.com/api/${process.env.TRADERJOE}/subgraphs/id/79gzKS8x9REyvAsqgQfgpuD4xX8mpr5HzysJiUF628iE`,
    ...
    },
    {
      chainId: ChainId.MATIC,
      subgraph:
        `https://gateway-arbitrum.network.thegraph.com/api/${process.env.TRADERJOE}/subgraphs/id/8VyL256uLZpZSMSPxYVqQcYckhvHQqqP1jKP2dZYWhnj`,
    ...
    },
    {
      chainId: ChainId.MATIC,
      subgraph:
        `https://gateway-arbitrum.network.thegraph.com/api/${process.env.TRADERJOE}/subgraphs/id/EWE671kZdZnHoQ7dNzaKr4ZcYe67APDYZ1jBrptnB9km`,
