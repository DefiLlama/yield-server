...
var API_URL = 'https://mainbackend.ratio.finance/lpairs';
var apy = function () { return __awaiter(_this, void 0, void 0, function () {
    var data, filteredData, pools;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, axios.get(API_URL)];
            case 1:
                data = (_a.sent()).data;
                filteredData = data.filter(function (pool) {
                    return pool.status == 'true';
                });
                pools = filteredData.map(function (pool) {
                    var assets = pool.assets.map(function (assets) {
                        return assets.mint;
                    });
                    var result = {
