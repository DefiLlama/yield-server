module.exports = [
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_stellaPerSec', type: 'uint256' },
      { internalType: 'address', name: '_teamAddress', type: 'address' },
      { internalType: 'address', name: '_treasuryAddress', type: 'address' },
      { internalType: 'address', name: '_investorAddress', type: 'address' },
      { internalType: 'uint256', name: '_teamPercent', type: 'uint256' },
      { internalType: 'uint256', name: '_treasuryPercent', type: 'uint256' },
      { internalType: 'uint256', name: '_investorPercent', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'accStellaPerShare', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'string[]', name: 'symbols', type: 'string[]' },
      { internalType: 'uint256[]', name: 'decimals', type: 'uint256[]' },
      { internalType: 'uint256[]', name: 'rewardsPerSec', type: 'uint256[]' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_newInvestorPercent', type: 'uint256' },
    ],
    name: 'setInvestorPercent',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_newTeamPercent', type: 'uint256' },
    ],
    name: 'setTeamPercent',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_newTreasuryPercent', type: 'uint256' },
    ],
    name: 'setTreasuryPercent',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    name: 'stella',
    outputs: [
      { internalType: 'contract IBoringERC20', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
