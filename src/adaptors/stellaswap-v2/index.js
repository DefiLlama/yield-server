...
const url = `https://gateway-arbitrum.network.thegraph.com/api/${process.env.TRADERJOE}/subgraphs/id/HgSAfZvHEDbAVuZciPUYEqFzhAUnjJWmyix5C1R2tmTp`
const urlStable =
  `https://gateway-arbitrum.network.thegraph.com/api/${process.env.TRADERJOE}/subgraphs/id/bqFx2yiB2VBH8LAJMGZ37Zj3NtBrY7gArFFciLaA3nE`
