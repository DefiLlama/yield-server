module.exports = {
  comptrollerAbi: [
    ...
    },
    {
      ...
      inputs: [
        {
          internalType: 'contract TectonicSocket',
          name: 'unitroller',
          type: 'address',
        },
      ],
    ...
    },
    {
      constant: false,
      inputs: [
        { internalType: 'address[]', name: 'tTokens', type: 'address[]' },
      ],
      name: 'enterMarkets',
      outputs: [{ internalType: 'uint256[]', name: '', type: 'uint256[]' }],
      payable: false,
    ...
    },
    {
      constant: false,
      inputs: [
        { internalType: 'address', name: 'tTokenAddress', type: 'address' },
      ],
      name: 'exitMarket',
      outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
      payable: false,
    ...
    },
    {
      ...
      name: 'getAllMarkets',
      outputs: [
        { internalType: 'contract TToken[]', name: '', type: 'address[]' },
      ],
      payable: false,
      stateMutability: 'view',
      type: 'function',
    ...
    },
    {
      constant: false,
      inputs: [
        { internalType: 'address', name: '_tonicAddress', type: 'address' },
      ],
  ...
  ercDelegator: [
      ...
      inputs: [
        {
          ...
          name: 'oldTectonicCore',
          type: 'address',
        },
        {
          indexed: false,
          internalType: 'contract TectonicCoreInterface',
          name: 'newTectonicCore',
          type: 'address',
        },
      ],
      name: 'NewTectonicCore',
    ...
    },
    {
      ...
      inputs: [
        {
          internalType: 'address',
          name: 'tonicLikeDelegatee',
          type: 'address',
        },
      ],
      name: '_delegateTonicLikeTo',
      outputs: [],
      payable: false,
      stateMutability: 'nonpayable',
      type: 'function',
