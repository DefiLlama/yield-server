module.exports = [
  ...
  },
  {
    ...
    name: 'MASTER_CHEF_V2',
    outputs: [
      { internalType: 'contract IMasterChefJoe', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint32', name: '_veJoeShareBp', type: 'uint32' },
  ...
  {
    inputs: [
      { internalType: 'contract IERC20', name: '_dummyToken', type: 'address' },
    ],
    name: 'init',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'contract IERC20', name: '_veJoe', type: 'address' },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint64', name: 'lastRewardTimestamp', type: 'uint64' },
      { internalType: 'contract IRewarder', name: 'rewarder', type: 'address' },
      { internalType: 'uint32', name: 'veJoeShareBp', type: 'uint32' },
      { internalType: 'uint256', name: 'totalFactor', type: 'uint256' },
  ...
  },
  {
    inputs: [
      { internalType: 'address', name: '_user', type: 'address' },
      { internalType: 'uint256', name: '_newVeJoeBalance', type: 'uint256' },
    ],
    name: 'updateFactor',
    outputs: [],
    stateMutability: 'nonpayable',
