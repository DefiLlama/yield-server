const GM_ASSET_VAULT_ABI = [
  {
    inputs: [
      { internalType: 'contract ERC20', name: '_asset', type: 'address' },
      { internalType: 'string', name: '_name', type: 'string' },
      { internalType: 'string', name: '_symbol', type: 'string' },
      { internalType: 'address', name: '_aggregateVault', type: 'address' },
    ],
  ...
  },
  {
    ...
    name: 'aggregateVault',
    outputs: [
      { internalType: 'contract AggregateVault', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_burnAmount', type: 'uint256' }],
    name: 'burnShares',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_depositFees', type: 'uint256' },
    ],
    name: 'lodgeAssets',
    outputs: [],
    stateMutability: 'nonpayable',
