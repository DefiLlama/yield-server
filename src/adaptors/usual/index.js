...
async function getUsualXAPY(chain, usualXPrice) {
  ...
  // Removed the weekly compounding multiplier for the APY
  const usualxApyReward = utils.aprToApy(usualXApr * 100);  // Corrected for APY
...
const apy = async () => {
  ...
  return [
    createPoolData(
      ...
      apyReward,  // Updated to use correct apyReward for USD0++
    ...
    createPoolData(
      ...
      apyReward,  // Updated for Arbitrum USD0++
